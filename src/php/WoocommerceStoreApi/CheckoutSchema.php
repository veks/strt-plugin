<?php
/**
 * Класс CheckoutSchema для расширения WooCommerce Store API дополнительными пользовательскими полями.
 * Используется для добавления/обновления пользовательских данных (например, координат доставки) в структуру оформления заказа.
 *
...
if ( ! class_exists( 'Strt\Plugin\WoocommerceStoreApi\CheckoutSchema' ) ) {

	/**
	 * Класс CheckoutSchema.
	 *
	...
	class CheckoutSchema {
		...
		public function init(): void {
			...
			add_action( 'woocommerce_store_api_checkout_update_customer_from_request', [ $this, 'handle_store_api_update_extensions' ], 10, 2 );
		}
